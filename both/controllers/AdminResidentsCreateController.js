AdminResidentsCreateController = RouteController.extend({
  template: 'admin_residents_create',
});
AdminResidentsCreateController.helpers({
  resident: function() {
...
AdminResidentsCreateController.events({
...
//Function to create users document.
